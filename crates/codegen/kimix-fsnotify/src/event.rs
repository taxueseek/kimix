//! Public event types — the wire contract for `Kimix-fsnotify`.
//!
...
//! translator (in `Kimix-workspace`) maps these to
...
/// Aligned with `kimix_workspace_types::FsEventKind` (identity map at
