...
/// The base prompt template source, exposed for `kimix prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `kimix prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard Kimix tool kinds.
