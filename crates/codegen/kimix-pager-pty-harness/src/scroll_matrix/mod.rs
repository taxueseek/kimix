...
//! `KIMIX_SCROLL_LOG` pointed at a tempfile, then validates the pager's
//! flight-recorder JSONL (producer:
//! `Kimix-tui/src/input/scroll_log.rs`) against gesture invariants.
//!
...
//! producer-side twin lives in `Kimix-tui/src/input/mouse/tests.rs`
