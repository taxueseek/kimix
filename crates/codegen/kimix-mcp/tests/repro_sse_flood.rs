...
//! Run with: cargo test -p Kimix-mcp --test repro_sse_flood -- --nocapture
use std::sync::Arc;
...
use kimix_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use kimix_mcp::rmcp::ServiceExt;
use kimix_mcp::rmcp::transport::StreamableHttpClientTransport;
use kimix_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
