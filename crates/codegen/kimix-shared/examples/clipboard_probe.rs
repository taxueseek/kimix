...
//! cargo build --release -p Kimix-shared --example clipboard_probe
//! hyperfine --warmup 2 \
//!   -n native './target/release/examples/clipboard_probe' \
//!   -n osascript 'KIMIX_CLIPBOARD_NO_NATIVE_READ=1 ./target/release/examples/clipboard_probe'
//! ```
//!
...
fn main() -> anyhow::Result<()> {
    ...
    let attachments = kimix_shared::clipboard::get_attachments()?;
