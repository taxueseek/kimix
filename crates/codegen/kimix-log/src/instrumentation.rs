...
const ENV_ENABLED: &str = "KIMIX_INSTRUMENTATION";
const ENV_LOG_PATH: &str = "KIMIX_INSTRUMENTATION_LOG";
const DEFAULT_LOG_DIR: &str = "logs";
const DEFAULT_LOG_FILE: &str = "instrumentation.log";
const DEFAULT_TRACE_FILE: &str = "instrumentation.trace.json";

pub const TARGET: &str = "kimix_instrumentation";
...
fn default_log_path() -> PathBuf {
    kimix_home().join(DEFAULT_LOG_DIR).join(DEFAULT_LOG_FILE)
}
...
fn default_output_path(mode: InstrumentationMode) -> PathBuf {
    let root = kimix_home().join(DEFAULT_LOG_DIR);
    match mode {
