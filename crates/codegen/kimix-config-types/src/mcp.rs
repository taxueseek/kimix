//! MCP server configuration value types, extracted from Kimix-shell
//! (config dependency inversion).
use agent_client_protocol as acp;
use indexmap::IndexMap;
use kimix_mcp::oauth_config::McpOAuthConfig;
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("KIMIX_RELAY_SYNC_ENABLED") {
