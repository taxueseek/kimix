...
//! Run with: cargo run -p Kimix-ratatui-textarea --example textarea_demo
//!
...
use kimix_ratatui_textarea::wrapping::{RtOptions, word_wrap_line};
use kimix_ratatui_textarea::{
