...
impl kimix_tool_runtime::Tool for MemorySearchImpl {
    type Args = MemorySearchInput;
    type Output = ToolOutput;

    fn id(&self) -> kimix_tool_protocol::ToolId {
        kimix_tool_protocol::ToolId::new("memory_search").expect("valid tool id")
    }
        ...
        let results = memory
            ...
            .map_err(|e| {
                kimix_tool_runtime::ToolError::execution(
                    kimix_tool_protocol::ToolId::new("memory_search").expect("valid"),
