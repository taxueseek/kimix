...
impl kimix_tool_runtime::Tool for MemoryGetImpl {
    type Args = MemoryGetInput;
    type Output = ToolOutput;

    fn id(&self) -> kimix_tool_protocol::ToolId {
        kimix_tool_protocol::ToolId::new("memory_get").expect("valid tool id")
    }
        ...
        let content = memory
            ...
            .map_err(|e| {
                kimix_tool_runtime::ToolError::execution(
                    kimix_tool_protocol::ToolId::new("memory_get").expect("valid"),
