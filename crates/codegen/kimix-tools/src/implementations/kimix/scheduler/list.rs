...
impl kimix_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl kimix_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> kimix_tool_protocol::ToolId {
        kimix_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, kimix_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                kimix_tool_runtime::ToolError::execution(
                    kimix_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
