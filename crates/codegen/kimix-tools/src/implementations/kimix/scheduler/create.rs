...
pub use kimix_tools_api::slash_commands::{
...
impl kimix_tool_runtime::ToolOutput for SchedulerCreateOutput {}
...
impl kimix_tool_runtime::Tool for SchedulerCreateTool {
    type Args = SchedulerCreateInput;
    type Output = SchedulerCreateOutput;

    fn id(&self) -> kimix_tool_protocol::ToolId {
        kimix_tool_protocol::ToolId::new(SCHEDULER_CREATE_TOOL_NAME).expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerCreateOutput, kimix_tool_runtime::ToolError> {
