...
crate::register_resource!("kimix", "ListDir", ListDirParams);
...
impl kimix_tool_runtime::Tool for ListDirTool {
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        let tool = ListDirTool;
        assert_eq!(kimix_tool_runtime::Tool::id(&tool).as_str(), "list_dir");
