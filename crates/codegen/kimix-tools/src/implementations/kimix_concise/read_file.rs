...
impl kimix_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // KimixConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::kimix::read_file::ReadFileTool;
