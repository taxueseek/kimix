...
impl kimix_tool_runtime::Tool for HashlineEditTool {
    type Args = HashlineEditInput;
    type Output = crate::types::output::SearchReplaceOutput;

    fn id(&self) -> kimix_tool_protocol::ToolId {
        kimix_tool_protocol::ToolId::new("hashline_edit").expect("valid tool id")
    }
    ...
    async fn run(
    ...
    ) -> Result<crate::types::output::SearchReplaceOutput, kimix_tool_runtime::ToolError> {
        ...
        let (cwd, display_cwd, fs, scheme, hints_enabled) = {
            ...
            let cwd = match ctx.extensions.get::<kimix_tool_runtime::Cwd>() {
            ...
            let scheme = params
                .0
                .build_scheme()
                .map_err(kimix_tool_runtime::ToolError::invalid_arguments)?;
...
mod tests {
    ...
    fn anchors_for(content: &str) -> Vec<String> {
        use crate::implementations::kimix_hashline::anchor::split_lines;
        use crate::implementations::kimix_hashline::edit::apply::anchor_suffix;
        use crate::implementations::kimix_hashline::scheme::{AnchorScheme, ChunkFingerprint};
    ...
    async fn output_is_tool_output_search_replace() {
        ...
        let result: crate::types::output::SearchReplaceOutput =
            kimix_tool_runtime::Tool::run(&tool, test_ctx(resources.into_shared()), input)
                .await
                .unwrap();
    ...
    fn test_scheme() -> Box<dyn crate::implementations::kimix_hashline::scheme::AnchorScheme> {
        crate::implementations::kimix_hashline::config::HashlineSchemeParams::default()
            .build_scheme()
            .unwrap()
    }
