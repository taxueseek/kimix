...
use crate::implementations::kimix_hashline::read_file::format_hashline_content;
use crate::implementations::kimix_hashline::scheme::{
...
mod tests {
    ...
    use crate::implementations::kimix_hashline::config::HashlineSchemeParams;
    use crate::implementations::kimix_hashline::scheme::{ChunkFingerprint, ContentOnly};
