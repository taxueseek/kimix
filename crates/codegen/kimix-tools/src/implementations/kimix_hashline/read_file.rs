...
//!
//! Reuses the core file-reading logic from [`Kimix::read_file::run_read_file`]
...
use crate::implementations::kimix::read_file::{ReadFileInput, run_read_file};
...
impl kimix_tool_runtime::Tool for HashlineReadTool {
    type Args = ReadFileInput;
    type Output = ReadFileOutput;

    fn id(&self) -> kimix_tool_protocol::ToolId {
        kimix_tool_protocol::ToolId::new("hashline_read").expect("valid tool id")
    }
...
mod tests {
    ...
    use crate::implementations::kimix::read_file::{MAX_LINES_READ, ReadFileTool};
    ...
    /// file content independently of Kimix `read_file`).
    #[tokio::test]
