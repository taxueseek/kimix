...
use crate::implementations::kimix::ask_user_question::AskUserQuestionInput;
use crate::implementations::kimix::enter_plan_mode::EnterPlanModeInput;
...
use crate::implementations::kimix::update_goal::UpdateGoalInput;
use crate::implementations::kimix::web_fetch::WebFetchInput;
use crate::implementations::kimix::web_search::WebSearchInput;
...
use kimix_tool_types::KillTaskToolInput;
use kimix_tool_types::TaskOutputToolInput;
use kimix_tool_types::TaskToolInput;
use kimix_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::kimix_hashline::edit::types::HashlineEditInput),
