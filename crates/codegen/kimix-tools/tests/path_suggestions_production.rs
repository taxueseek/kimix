...
//! Run:
//! ```bash
//! cargo test -p Kimix-tools --test path_suggestions_production
//! ```
use kimix_tools::util::path_suggestions::{format_not_found_error, path_not_found_hint};
...
fn similar_names(hint: &kimix_tools::util::path_suggestions::PathNotFoundHint) -> Vec<String> {
    hint.similar
        .iter()
...
#[tokio::test]
async fn pattern2_kimix_sessions_internal_path() {
