...
///
/// - `osc52_sink`: when `kimix wrap` is capturing this process's output (see
...
mod tests {
    ...
    // `kimix wrap` sink: a brand that does NOT natively support OSC 52 (the
    ...
    // container override is deliberately narrow; `kimix wrap` is the SSH path.
    #[test]
