//! KimixDay theme — neutral gray base (light) with deepened accent colors.
//!
//! Light counterpart to KimixNight. Backgrounds and text use a neutral
//! grayscale ramp (no blue/warm tint). Accent colors are the same hue
//! family as KimixNight but deepened for contrast on light backgrounds.
