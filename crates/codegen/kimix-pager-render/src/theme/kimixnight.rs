//! KimixNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// KimixNight palette — neutral gray base + TokyoNight accent colors.
//
...
mod tests {
    ...
    fn test_kimixnight_theme() {
        let theme = Theme::kimixnight();
