...
//! `Kimix-tui/src/ui/style.rs` for consistency. The `Theme` struct maps
...
// Keep in sync with Kimix-tui TokyoNightNight.
#[allow(dead_code)]
pub mod palette {
    use super::*;
...
pub struct Theme {
    ...
    // Animation style for the welcome screen moon
    pub animation: MoonAnimation,
}
...
pub enum MoonAnimation {
    ...
    Standard,
    /// Moon Dark: cold silver breathing, star twinkling background
    MoonDark,
    /// Moon Light: warm golden glow, radiant corona
    MoonLight,
    /// Blood Moon: crimson pulse with blood drip particles + wobble
    BloodMoon,
    /// Grok: digital hexagonal "X" logo with scan-line effect
    GrokX,
...
impl Theme {
    ...
    pub const fn tokyonight() -> Self {
        Self {
            ...
            md_text: FG,
            link_fg: BLUE, // #7aa2f7
            animation: MoonAnimation::Standard,
        }
    }
