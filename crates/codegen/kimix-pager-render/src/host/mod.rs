...
/// WSL detection. The implementation lives in `Kimix-tty-utils` (the shared
...
pub use kimix_tty_utils::is_wsl;
...
// tests live with the implementation in `Kimix-tty-utils`.
