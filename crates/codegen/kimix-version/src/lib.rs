//! Installed Kimix CLI version, lockstepped with shipping binaries.
use semver::Version;

pub const TEST_VERSION_ENV: &str = "KIMIX_TEST_VERSION";

pub const VERSION: &str = match option_env!("KIMIX_VERSION") {
    Some(v) => v,
