...
fn id_from_path_strips_worktree_prefix_and_hashes_full_path() {
    let p = Path::new("/home/.kimix/worktrees/myrepo/worktree-019caa03");
    assert_id_shape(&id_from_path(p), "019caa03");
    assert_id_shape(
        &id_from_path(Path::new("/home/.kimix/worktree_pool/inst/a1b2c3")),
        "a1b2c3",
    );
...
fn id_from_path_differs_for_same_basename_in_different_repos() {
    ...
    let a = id_from_path(Path::new("/home/.kimix/worktrees/repo-a/session/wt-abc"));
    let b = id_from_path(Path::new("/home/.kimix/worktrees/repo-b/session/wt-abc"));
    assert_ne!(
        a, b,
...
fn same_basename_worktrees_in_different_repos_coexist() {
    ...
    let path_a = "/home/.kimix/worktrees/repo-a/session/wt-abc";
    let path_b = "/home/.kimix/worktrees/repo-b/session/wt-abc";
