...
//! Run with:
//!   cargo run -p Kimix-markdown --features playground --bin md-mermaid-test
//!
...
use kimix_markdown::{MarkdownBuffers, MarkdownStyle, render_markdown_ratatui_with_buffers_width};
use kimix_ratatui_textarea::{TextArea, TextAreaState};
