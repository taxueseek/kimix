//! Kimix-hunk-tracker - Track file hunks (diffs) with agent/external attribution.
//!

//! This crate provides:
//! - Actor-based hunk tracking with source attribution (Agent vs External)
//! - Integration with Kimix-shell sessions
//!
...
//! ```rust,ignore
//! use kimix_hunk_tracker::{HunkTrackerActor, HunkEvent, TrackingMode, HunkAction};
//! use tokio::sync::mpsc;
//!
