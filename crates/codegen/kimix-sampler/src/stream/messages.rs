...
use kimix_sampling_types::messages::{self, MessageStreamEvent};
        ...
        loop {
            ...
            match event {
                ...
                MessageStreamEvent::ContentBlockStart {
                    ...
                    _ => {
                        // Image / ToolResult / ServerToolUse are not expected
                        // in assistant streams. Log for observability.
                        tracing::debug!(?index, "unrecognized content block in assistant stream");
                    }
                },
