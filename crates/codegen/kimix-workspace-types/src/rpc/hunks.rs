...
/// Wire-safe hunk action enum. Maps to `kimix_hunk_tracker::types::HunkAction`
...
// =========================================================================
// Request types whose responses reference `kimix_hunk_tracker` types (which pull
...
// =========================================================================
// Wire mirrors of `kimix_hunk_tracker` response types
// =========================================================================

/// Wire mirror of `kimix_hunk_tracker::types::Hunk` (the `selected` field is
...
/// Wire mirror of `kimix_hunk_tracker::types::HunkLineInfo`.
...
/// Wire mirror of `kimix_hunk_tracker::types::HunkSource`.
///
...
/// Wire mirror of `kimix_hunk_tracker::types::FileContentStatus`.
///
...
/// Wire mirror of `kimix_hunk_tracker::types::FileContentView`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `kimix_hunk_tracker::types::FileContentEntry`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `kimix_hunk_tracker::types::SessionStats`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `kimix_hunk_tracker::types::TurnSummary`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `kimix_hunk_tracker::types::SessionSummary`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
