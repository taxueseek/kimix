...
/// Claude.md / `.Kimix/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.kimix` and compat dirs.
...
/// Mirrors the serde shape of `Kimix-agent`'s `AgentConfigFile`.
