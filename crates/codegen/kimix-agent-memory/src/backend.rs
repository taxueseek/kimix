...
use kimix_tools::types::memory_backend::{MemoryBackend, MemorySearchResult};
...
pub struct MemoryBackendParams {
    ...
    pub embed_config: Option<kimix_config_types::MemoryEmbeddingConfig>,
    ...
    pub search_config: kimix_config_types::MemorySearchConfig,
    ...
    pub auth_credentials: Option<Arc<dyn kimix_auth::AuthCredentialProvider>>,
}
...
async fn build_embedding_provider(
    config: Option<&kimix_config_types::MemoryEmbeddingConfig>,
    auth_credentials: Option<&Arc<dyn kimix_auth::AuthCredentialProvider>>,
...
pub struct MemoryBackendImpl {
    ...
    embed_config: Option<kimix_config_types::MemoryEmbeddingConfig>,
    ...
    search_config: kimix_config_types::MemorySearchConfig,
...
impl MemoryBackendImpl {
    ...
    pub fn new(db_path: PathBuf, storage: MemoryStorage) -> Self {
        Self {
            ...
            embed_api_key: None,
            search_config: kimix_config_types::MemorySearchConfig::default(),
            watcher: None,
            stale_claim_secs: 60,
    ...
    pub fn with_embedding(
        mut self,
        config: kimix_config_types::MemoryEmbeddingConfig,
        base_url: String,
    ...
    pub fn with_search_config(mut self, config: kimix_config_types::MemorySearchConfig) -> Self {
    ...
    fn open_readonly(&self) -> Result<rusqlite::Connection, rusqlite::Error> {
        ...
        kimix_sqlite_journal::JournalMode::for_db_path(&self.db_path).open_readonly(&self.db_path)
    }
...
impl MemoryBackendImpl {
    ...
    pub fn search_config_for_test(&self) -> &kimix_config_types::MemorySearchConfig {
        &self.search_config
    }
}
...
impl MemoryBackend for MemoryBackendImpl {
    ...
    async fn search(
        ...
        let mut index = super::index::MemoryIndex::open_or_create(
            &self.db_path,
            self.storage.clone(),
            kimix_config_types::MemoryIndexConfig::default(),
            embed_dims,
        )
...
mod factory_tests {
    ...
    use kimix_config_types::{MemoryEmbeddingConfig, MemorySearchConfig};
    ...
    fn test_factory_wires_non_overridable_search_config_fields() {
        ...
        let custom_search = MemorySearchConfig {
            max_results: 7,
            mmr: kimix_config_types::MmrConfig {
                enabled: true,
                lambda: 0.42,
            },
            temporal_decay: kimix_config_types::TemporalDecayConfig {
                enabled: true,
                half_life_days: 14.0,
            },
            ..Default::default()
    ...
    async fn make_embedding_provider_uses_async_api_key_resolution() {
        use kimix_tools::types::ApiKeyProvider;
        ...
        let probe: kimix_tools::types::SharedApiKeyProvider = Arc::new(AsyncProbe {
...
mod tests {
    use super::*;
    use crate::index::{MemoryIndex, init_sqlite_vec};
    use kimix_config_types::MemoryIndexConfig;
    use tempfile::TempDir;
