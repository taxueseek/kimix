...
//! Kimix to persist important information across sessions. Memory files are
//! stored under `~/.kimix/memory/` with workspace-scoped subdirectories
...
//! `KIMIX_MEMORY=1` environment variable. When disabled, this crate
