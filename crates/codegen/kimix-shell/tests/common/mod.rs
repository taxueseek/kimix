//! Shared helpers for Kimix-shell integration tests.
use kimix_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `kimix_sampler::SamplingClient`, which takes a
