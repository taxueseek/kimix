...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "KIMIX_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "KIMIX_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`KIMIX_MIN_DRAW_MS` / `KIMIX_SCROLL_CADENCE_MS`).
