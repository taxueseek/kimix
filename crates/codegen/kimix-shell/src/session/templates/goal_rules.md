...
**Before executing, apply first-principles analysis:**
1. Strip assumptions — question what the user said vs what they actually need
2. Identify root causes — the symptom is often not the problem
3. Define measurable success criteria — "done" must be quantifiable
