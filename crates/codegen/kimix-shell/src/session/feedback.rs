//! Feedback request heuristics for Kimix Code sessions.
//!
...
impl FeedbackHeuristics {
    ...
    pub fn new() -> Self {
        Self {
            ...
            tier1_prompt:
                "You've been using Kimix Code productively! Would you mind sharing quick feedback?"
                    .to_string(),
...
impl FeedbackRequest {
    ...
    pub fn with_mode(
        ...
        let prompt = match prompt_override {
            ...
            _ => match tier {
                FeedbackTier::Tier1 => {
                    "You've been using Kimix Code productively! Would you mind sharing quick feedback?".to_string()
                }
                FeedbackTier::Tier2 => {
