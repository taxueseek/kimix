...
/// `KIMIX_PROMPT_SUGGESTIONS_MODEL` keeps working for models the catalog does
...
mod tests {
    ...
    fn effective_model_default_requires_catalog() {
        ...
        // OAuth catalogs exclude Kimix-0.1 → skip the request entirely,
    ...
    fn effective_model_env_pin_bypasses_catalog_guard() {
        // KIMIX_PROMPT_SUGGESTIONS_MODEL is the explicit escape hatch: used
