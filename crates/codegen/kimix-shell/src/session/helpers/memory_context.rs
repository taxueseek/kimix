...
use kimix_chat_state::{MEMORY_CONTEXT_CLOSE_TAG, MEMORY_CONTEXT_OPEN_TAG};
use kimix_sampling_types::ConversationItem;
use kimix_tools::types::memory_backend::{MemorySearchResult, format_staleness_note};
...
mod tests {
    ...
    fn test_format_memory_reminder_empty_results_is_none() {
        use kimix_tools::types::memory_backend::MemorySearchResult;
