...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<kimix_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(kimix_tools::implementations::kimix::update_goal::UpdateGoalInput),
    Channel(kimix_tools::implementations::kimix::update_goal::UpdateGoalEnvelope),
}
