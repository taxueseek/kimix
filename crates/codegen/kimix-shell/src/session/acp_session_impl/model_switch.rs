...
impl SessionActor {
    pub(super) async fn handle_set_session_model(
        ...
        self.chat_state_handle
            .update_sampling_config(kimix_sampling_types::SamplingConfig {
    ...
    ///
    /// Builds a fresh [`kimix_agent::Agent`] from the cached
    /// [`crate::session::agent_rebuild::AgentRebuildSpec`] + the supplied
    /// [`kimix_agent::AgentDefinition`], replaces `self.agent`,
