...
//! Provides access to the Kimix-hunk-tracker functionality for tracking file changes
...
pub async fn handle(
    ...
    match args.method.as_ref() {
        ...
        "kimix/hunk-tracker/get-all-file-contents" => {
            let req = parse_params::<GetFilesRequest>(args)?;
        ...
        "kimix/hunk-tracker/get-summary" => {
        ...
        // Single Hunk Action
        // ───────────────────────────────────────────────────────────────
        "kimix/hunk-tracker/hunk-action" => {
        ...
        // Bulk Actions
        // ───────────────────────────────────────────────────────────────
        "kimix/hunk-tracker/file-action" => {
        ...
        "kimix/hunk-tracker/turn-action" => {
