...
/// Wire DTO for the `Kimix/subagent/cancel` response payload (under `result` in
...
/// Handle `Kimix/scheduler/*` extension methods.
...
/// Handle `Kimix/subagent/*` extension methods.
...
mod tests {
    ...
    // ── Kimix/subagent/cancel outcome wire DTO ──────────────────────────
