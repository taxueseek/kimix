...
use kimix_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use kimix_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        "kimix/search/content" => {
            ...
            // `Kimix/search/content/status` batches through the client sink.
