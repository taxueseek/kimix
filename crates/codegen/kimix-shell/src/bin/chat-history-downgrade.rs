...
use clap::Parser;
use kimix_shell::sampling::conversation::{ConversationItem, conversation_item_to_chat_message};
use kimix_shell::sampling::types::{ChatRequestMessage, Role};
...
mod tests {
    ...
    fn test_assistant_with_reasoning() {
        let v1 = r#"{"type":"assistant","content":"The answer is 42.","reasoning":{"text":"Let me think..."},"tool_calls":[],"model_id":"kimix-3"}"#;
        let out = convert_line_for_test(v1);
        let v = v0_value(&out);
        assert_eq!(v["role"], "assistant");
        assert_eq!(v["content"], "The answer is 42.");
        assert_eq!(v["reasoning_content"], "Let me think...");
        assert_eq!(v["model_id"], "kimix-3");
    }
    ...
    fn test_sibling_reasoning_folds_into_following_assistant() {
        ...
        let a_line = r#"{"type":"assistant","content":"The answer is 42.","tool_calls":[],"model_id":"kimix-3"}"#;
