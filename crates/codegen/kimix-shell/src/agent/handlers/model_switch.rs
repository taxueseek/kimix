...
use kimix_sampling_types::parse_reasoning_effort_meta;
...
pub(crate) async fn apply(
    ...
    let mut pending_rebuild_definition: Option<kimix_agent::AgentDefinition> = None;
    {
        ...
        if is_mismatch && turn_count == 0 {
            ...
            let resolved = kimix_agent::discovery::by_name_in_cwd_with_plugins(
                required,
                cwd,
