...
pub struct SessionRegistryClient {
    ...
    base_url: String,
    credentials: crate::util::kimix_auth_credentials::KimixAuthCredentials,
...
impl SessionRegistryClient {
    pub fn new(base_url: impl Into<String>, user_token: impl Into<String>) -> Self {
        ...
        Self {
            ...
            credentials: crate::util::kimix_auth_credentials::KimixAuthCredentials::new(Some(
                user_token.into(),
            )),
            session_id: None,
        }
    ...
    async fn send_authed(
        ...
        let builder = kimix_file_utils::trace_context::inject_trace_context_into_request(builder);
