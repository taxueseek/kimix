...
//! two ways:
//!
//!   - request/response `Kimix/sessions/list` → `{ "sessions": [RosterEntry, …] }`
//!   - broadcast notification `Kimix/sessions/changed` →
...
/// Response payload for `Kimix/sessions/list`.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
pub struct RosterListResponse {
    pub sessions: Vec<RosterEntry>,
}

/// Params payload for the `Kimix/sessions/changed` broadcast notification.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
...
pub const SESSIONS_LIST_METHOD: &str = "kimix/sessions/list";
pub const SESSIONS_CHANGED_METHOD: &str = "kimix/sessions/changed";
