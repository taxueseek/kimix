...
//
// State is persisted to `~/.kimix/claude_import_state.json`.
...
use kimix_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.kimix/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::kimix_home::kimix_home().join("claude_import_state.json")
}
