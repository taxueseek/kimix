//! Retry utilities — re-exported from `Kimix-tools`.
//!
//! The canonical implementation now lives in `kimix_tools::retry`.
//! This module re-exports with backward-compatible aliases.
pub use kimix_tools::retry::BackoffConfig as RetryConfig;
pub use kimix_tools::retry::{BackoffConfig, execute_with_backoff};
