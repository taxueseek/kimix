//! Todo types — re-exported from `Kimix-tools` with ACP conversion helpers.
//!
//! Types are canonical in `Kimix-tools`. This module adds ACP ↔ TodoItem
//! conversions since `Kimix-tools` is protocol-agnostic.
pub use kimix_tools::implementations::kimix::todo::TodoId;
pub use kimix_tools::implementations::kimix::todo::TodoItem;
pub use kimix_tools::implementations::kimix::todo::TodoPriority;
pub use kimix_tools::implementations::kimix::todo::TodoState;
pub use kimix_tools::implementations::kimix::todo::TodoStatus;
