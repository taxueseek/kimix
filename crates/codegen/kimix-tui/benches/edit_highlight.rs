...
//!
//! ```text
//! cargo bench -p kimix-tui --bench edit_highlight
//! cargo bench -p kimix-tui --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use kimix_tui::diff::{DiffHunk, DiffLine};
use kimix_tui::scrollback::blocks::tool::{
...
use kimix_tui::syntax::{Syntect, get_syntect};
