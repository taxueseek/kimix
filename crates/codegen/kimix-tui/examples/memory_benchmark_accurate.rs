...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "kimix-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "kimix-3", "researcher");
    ...
    let shared_models = ["kimix-3", "kimix-3-mini"];
