...
use kimix_tui::app::mermaid_worker::render_via_subprocess;
use kimix_tui::scrollback::blocks::mermaid_content::MermaidRenderQuality;
...
fn tight_timeout_kills_child_and_returns_err() {
    ...
    // `kimix_mermaid::subprocess` `reap_terminates_the_process` unit test;
