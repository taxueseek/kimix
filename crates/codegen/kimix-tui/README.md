...
Terminal UI (TUI) for Kimix. Provides the interactive full-screen interface
...
- [Hook Examples](../kimix-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`kimix-hooks`)](../kimix-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`kimix-plugin-marketplace`)](../kimix-plugin-marketplace/) — marketplace source loading, scanning, and install
