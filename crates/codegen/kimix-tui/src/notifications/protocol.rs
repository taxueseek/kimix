...
pub enum NotificationProtocol {
    ...
    Osc9,
    /// Kitty: `\x1b]99;i=Kimix;{message}\x1b\\`
    Osc99,
...
pub fn select_protocol(ctx: &TerminalContext) -> NotificationProtocol {
    ...
    match ctx.brand {
        ...
        TerminalName::KimixDesktop => NotificationProtocol::None,
...
pub fn emit_notification(
    ...
    let sequence: Cow<'_, str> = match protocol {
        ...
        NotificationProtocol::Osc99 => {
            format!("\x1b]99;i=kimix;{body} \u{b7} {title}\x1b\\").into()
        }
        NotificationProtocol::Osc777 => format!("\x1b]777;notify;Kimix;{body}\x1b\\").into(),
...
mod tests {
    ...
    #[test]
    fn select_kimix_desktop_uses_none() {
        assert_eq!(
            select_protocol(&ctx_with_brand(TerminalName::KimixDesktop)),
    ...
    fn emit_none_is_noop() {
        let ctx = ctx_with_brand(TerminalName::KimixDesktop);
