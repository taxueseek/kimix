...
//! `/docs web` opens the Kimix project docs in the browser.
...
pub const BUILD_DOCS_URL: &str = "https://github.com/taxueseek/kimix#readme";
    ...
    fn suggest_args(&self, _ctx: &AppCtx, _args_query: &str) -> Option<Vec<ArgItem>> {
        let mut items = vec![
            ...
            ArgItem {
                ...
                description: "Open docs.kimix/build in the browser".into(),
            },
        ];
