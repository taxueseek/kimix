...
pub(crate) fn map_hyperlinks_to_overlay(
    hyperlinks: &[kimix_markdown::HyperlinkTarget],
...
mod tests {
    ...
    fn make_hyperlink(
        ...
        url: &str,
        id: u32,
    ) -> kimix_markdown::HyperlinkTarget {
        kimix_markdown::HyperlinkTarget {
            line_index: line,
            column_range: cols,
            url: url.to_string(),
    ...
    fn overlay_empty_hyperlinks_produces_nothing() {
        ...
        let links: &[kimix_markdown::HyperlinkTarget] = &[];
        let mut overlay = LinkOverlay::new();
        map_hyperlinks_to_overlay(links, &output, 0, 0, 10, 0, 0, &[], &mut overlay);
    ...
    fn markdown_wrapped_session_media_path_fully_linkified() {
        ...
        let path = "/Users/alice/.kimix/sessions/%2FUsers%2Falice%2Fcode%2Fxai/\
