...
use kimix_tui::views::question_view::{
...
fn example_scenarios() -> Vec<(&'static str, Vec<Question>)> {
    vec![
        ...
        (
            "Multi-tab: architecture decisions (Tab to switch)",
            vec![
                Question {
...
fn draw(f: &mut ratatui::Frame, app: &mut App) {
    ...
    let header = Paragraph::new(vec![
        ...
        Line::from("j/k: navigate  Space/Enter: select  Tab: switch tab  n/p: scenario  Esc: quit"),
    ])
