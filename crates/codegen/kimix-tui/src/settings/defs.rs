...
const THEME_CHOICES: &[EnumChoice] = &[
    ...
    EnumChoice {
        canonical: "sakura",
        display: "Sakura",
        description: "Dark plum with sakura-pink accents. 暗夜樱花。",
    },
    EnumChoice {
        canonical: "forest",
        display: "Forest",
        description: "Dark green with jade accents. 暗夜森林。",
    },
    EnumChoice {
        canonical: "moon-dark",
        display: "Moon Dark",
        description: "Deep space black with cold blue. 月之暗面。",
    },
    EnumChoice {
        canonical: "moon-light",
        display: "Moon Light",
        description: "Moonlit white with warm silver. 月之亮面。",
    },
    EnumChoice {
        canonical: "blood-moon",
        display: "Blood Moon",
        description: "Deep crimson with blood red glow. 红月。",
    },
    EnumChoice {
        canonical: "grok-dark",
        display: "Grok Dark",
        description: "Grok inspired dark theme.",
    },
    EnumChoice {
        canonical: "deepseek-blue",
        display: "DeepSeek Blue",
        description: "Deep ocean blue whale theme. 蓝鲸。",
    },
];
...
// Language catalog.
//
// Persisted to `[ui].language` in config.toml. `"auto"` means "follow the
// system locale": `i18n::Lang::detect()` resolves zh-prefixed locales to
// Chinese and everything else to English; the stored value `"auto"` is
// skipped at read time so detection always runs.
//
// Canonical strings match `i18n::Lang::parse` / `Lang::code` plus the
// `"auto"` sentinel understood by `dispatch::settings::set_language`.
// `supports_preview: false` — the switch is applied immediately on commit
// (runtime `i18n::set_current` + toast), no per-keystroke preview path.
// ---------------------------------------------------------------------------

// Choice order: auto (default) → zh → en.
const LANGUAGE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        canonical: "auto",
        display: "Auto",
        description: "Follow the system locale. 跟随系统语言。",
    },
    EnumChoice {
        canonical: "zh",
        display: "中文",
        description: "Simplified Chinese interface. 简体中文界面。",
    },
    EnumChoice {
        canonical: "en",
        display: "English",
        description: "English interface. 英文界面。",
    },
];
...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open Kimix in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open Kimix in scrollback-native (minimal) mode.",
    },
];
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain kimix opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "kimixnight".
                default: "kimixnight",
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shared,
            label: "Language",
            description: "Interface language. Auto follows the system locale \
                         (Chinese systems show 中文, others show English).",
            keywords: &[
                "language", "lang", "locale", "chinese", "english", "i18n", "中文", "英文", "语言",
            ],
            kind: SettingKind::Enum {
                // `"auto"` = follow system locale; resolved at read time by
                // `i18n::Lang::detect` (the stored "auto" is skipped).
                default: "auto",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "kimixnight".
                default: "kimixnight",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "kimixday".
                default: "kimixday",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "kimix", "switch"],
        ...
        // The `KIMIX_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "Plan mode",
            description: "Suggest plan mode (Tab) when your prompt looks like a \
                          planning request.",
            keywords: &["plan", "mode", "nudge", "tab", "hint"],
            kind: SettingKind::Bool {
