#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// and the shell emits the queue-emptying `Kimix/queue/changed` right after
    ...
    /// `Kimix/task_backgrounded` arriving after the skipped zero-work wait
    /// re-evaluates and restores the park.
    #[test]
    ...
    fn interjection_notification_pushes_block_to_matching_session() {
        ...
        // the shell as Kimix/session/interjection; EVERY attached pane (incl.
