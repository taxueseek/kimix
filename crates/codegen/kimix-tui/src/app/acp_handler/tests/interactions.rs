#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn ask_user_question_routes_to_background_session_not_active_view() {
        ...
        .unwrap();
        let msg = AcpClientMessage::ExtMethod(kimix_acp_lib::AcpArgs {
            request: acp::ExtRequest::new("kimix/ask_user_question", raw.into()),
            response_tx: tx,
        });
    ...
    fn close_viewer_preserves_plan_approval_state() {
        ...
        handle(
            AcpClientMessage::ExtMethod(kimix_acp_lib::AcpArgs {
                request: acp::ExtRequest::new("kimix/exit_plan_mode", raw.into()),
                response_tx: tx,
            }),
            &mut app,
        );
