    ...
    fn goal_updated_ignores_unknown_json_fields_via_serde() {
        ...
        let raw_payload = serde_json::json!({
            ...
            "update": {
                ...
                "live_tokens_by_model": [["kimix-4", 6_000], ["kimix-3", 4_000]],
                "live_context_pct": 42,
                "live_turn_count": 7,
        ...
        let request = acp::ExtNotification::new("kimix/session_notification", raw.into());
        ...
        assert_eq!(
            ...
            vec![("kimix-4".to_owned(), 6_000), ("kimix-3".to_owned(), 4_000)],
