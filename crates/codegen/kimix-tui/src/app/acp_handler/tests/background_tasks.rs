#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// notifications through the generic `Kimix/session/update` envelope. A
    ...
    fn ext_session_update_replay_restores_bg_task() {
        ...
        handle(
            make_ext_session_notification_with_method("sess-1", "kimix/session/update", update),
            &mut app,
        );
    ...
    fn task_backgrounded_with_wire_description_still_drains_deferred_tool() {
        ...
        let notif = acp::ExtNotification::new("kimix/task_backgrounded", raw.into());
