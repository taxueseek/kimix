...
/// Show session info: fetch via Kimix/session/info and display in scrollback.
///
...
/// Show context info: fetch via Kimix/session/info and display rich breakdown.
///
...
///
/// Produces [`Effect::FetchUsage`], which asks the shell's `Kimix/billing`
...
fn format_usage_rows(rows: &[kimix_shell::extensions::billing::UsageRow]) -> String {
