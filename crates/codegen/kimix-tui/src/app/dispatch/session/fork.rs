...
-> [kimix_tools::implementations::kimix::ask_user_question::QuestionOption; 2] {
    use kimix_tools::implementations::kimix::ask_user_question::QuestionOption;
    [
        QuestionOption {
...
/// [`Effect::ForkSession`] which calls `Kimix/session/fork` directly.
