...
pub(super) mod paste_key_tests {
    ...
    -> crate::views::question_view::QuestionViewState {
        let question = kimix_tools::implementations::kimix::ask_user_question::Question {
            question: "Pick one?".to_string(),
            options: vec![
                kimix_tools::implementations::kimix::ask_user_question::QuestionOption {
                    label: "A".to_string(),
