...
pub enum QueueRowOrigin {
    ...
    /// while running). Edits route to the agent as `Kimix/queue/*`.
    Server,
}
...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. KimixNight's dark band leaking into KimixDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default KimixNight, dark) after the user switches —
        // painting a dark band on a light KimixDay canvas.
