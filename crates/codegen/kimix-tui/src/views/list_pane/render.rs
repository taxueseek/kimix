...
mod tests {
    ...
    fn highlight_match_wrap_mode_real_tracing_line() {
        ...
        let styled = Line::from(vec![
            ...
            Span::raw(" "),
            Span::styled(
                "kimix_shell::session::acp_session:",
                Style::default().fg(Color::DarkGray),
            ),
            Span::raw(
