...
use kimix_acp_lib::AcpResult;
use kimix_markdown::StreamingMarkdownRenderer;
pub use kimix_tools::implementations::kimix::ask_user_question::{
...
/// driven by an ACP `Kimix/ask_user_question` request).
///
...
///
/// Created when an `Kimix/ask_user_question` ext-method request arrives;
...
pub struct QuestionViewState {
    ...
    /// instead of by an ACP `Kimix/ask_user_question` request. `None` for
...
impl QuestionViewState {
    ...
    ///
    /// Called by the `ExtMethod` handler when a blocking `Kimix/ask_user_question`
...
impl QuestionViewState {
    ...
    pub fn build_accepted_response(
        &self,
    ) -> kimix_tools::implementations::kimix::ask_user_question::AskUserQuestionExtResponse {
    ...
    pub fn send_ext_response(
        &mut self,
        response: kimix_tools::implementations::kimix::ask_user_question::AskUserQuestionExtResponse,
    ) -> bool {
