...
impl SourceFilter {
    pub fn label(self) -> &'static str {
        match self {
            Self::All => i18n::tr("All"),
            Self::Local => i18n::tr("Local"),
            Self::Remote => i18n::tr("Remote"),
            Self::External => i18n::tr("External"),
        }
    }
...
pub(crate) fn capture_picker_selection(
    ...
    content_results: Option<&[kimix_shell::extensions::session_search::SearchSessionHit]>,
    state: &PickerState,
    query: &str,
    grouped: bool,
...
pub(crate) fn build_content_entry_data(
    hits: &[kimix_shell::extensions::session_search::SearchSessionHit],
    entries_data: &[SessionPickerEntry],
    filtered_indices: &[usize],
    state: &PickerState,
    content_start: usize,
