...
pub fn build_entries(
    files: Vec<kimix_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn file_label_extracts_filename() {
        assert_eq!(
            file_label("/home/user/.kimix/memory/MEMORY.md"),
            "MEMORY.md"
        );
        assert_eq!(
            file_label("/workspace/.kimix/memory/sessions/2026-01-15-fix-bug.md"),
    ...
    fn build_entries_groups_by_source() {
        use kimix_shell::extensions::notification::MemoryFileInfo;
