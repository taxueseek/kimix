...
impl GroupKind {
    ...
    fn label(self) -> &'static str {
        match self {
            GroupKind::Subagents => crate::i18n::tr("Subagents"),
            GroupKind::Tasks => crate::i18n::tr("Tasks"),
            GroupKind::Watchers => crate::i18n::tr("Watchers"),
        }
    }
            ...
            if inner.height > 0 && inner.width > 0 {
                ...
                if self.show_done {
                    ...
                    let line = Line::from(vec![
                        Span::styled(i18n::tr("No running tasks. Press "), muted),
                        Span::styled("h", key_style),
                        Span::styled(i18n::tr(" to show all."), muted),
                    ]);
