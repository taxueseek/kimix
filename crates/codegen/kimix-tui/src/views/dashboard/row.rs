...
mod tests {
    ...
    fn idle_local_agent_without_message_has_blank_secondary() {
        let agent = make_idle_agent_with_model(Some("kimix-4.5"));
    ...
    fn subtitle_worktree_shows_label_branch_and_marker() {
        ...
        agent.session.cwd = PathBuf::from("/home/me/.kimix/worktrees/x/location-picker");
