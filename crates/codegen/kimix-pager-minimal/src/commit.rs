...
use kimix_tui::appearance::AppearanceConfig;
use kimix_tui::minimal_api;
use kimix_tui::render::Renderable;
use kimix_tui::scrollback::block::RenderBlock;
use kimix_tui::scrollback::blocks::ToolCallBlock;
use kimix_tui::scrollback::entry::{EntryId, ScrollbackEntry};
...
mod tests {
    ...
    fn terminal_native_lock_paints_only_native_colors() {
        use kimix_tui::theme::cache as theme_cache;
        use ratatui::buffer::Buffer;
        ...
        impl Drop for LockReset {
            fn drop(&mut self) {
                kimix_tui::theme::cache::set_terminal_native_lock(false);
            }
        }
