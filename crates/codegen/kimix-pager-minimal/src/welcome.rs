...
//!
//! It is printed via [`kimix_ratatui_inline::Terminal::insert_before`] — the same
...
pub fn maybe_commit_welcome(app: &mut AppView, terminal: &mut PagerTerminal) {
    ...
    let border_color = kimix_tui::render::color::blend_color(theme.bg_base, theme.gray_dim, 0.45)
