...
use kimix_tui::views::extensions_modal::{ExtensionsTab, TabDataState};
use kimix_tui::views::modal::ActiveModal;
use kimix_tui::views::picker::{self, PickerEntry, PickerField, PickerHitAreas, PickerRow};
...
mod tests {
    use super::*;
    use kimix_tui::views::extensions_modal::ExtensionsModalState;
    use kimix_tui::views::mcps_modal::{McpServerDisplayStatus, McpServerInfo};
    use ratatui::layout::Rect;
    ...
    fn session_entry(id: &str) -> kimix_tui::app::app_view::SessionPickerEntry {
        kimix_tui::app::app_view::SessionPickerEntry {
            id: id.into(),
            summary: id.into(),
    ...
    fn with_resume(entries: Vec<kimix_tui::app::app_view::SessionPickerEntry>) -> AgentView {
        let mut a = agent();
        a.active_modal = Some(ActiveModal::SessionPicker {
            ...
            window: kimix_tui::views::modal_window::ModalWindowState::new(),
            content_results: None,
            content_loading: false,
            deep_search_seq: 0,
            source_filter: kimix_tui::views::session_picker::SourceFilter::default(),
            pending_delete: None,
            entries_query: None,
        });
        a
