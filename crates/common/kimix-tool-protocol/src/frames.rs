...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `Kimix-tool-runtime`. Sampler-side wire
...
/// `kimix_computer_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<kimix_tool_types::ToolDescription>,
}
