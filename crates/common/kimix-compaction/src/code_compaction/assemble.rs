//! Compacted-history assembly (Kimix's rebuild structure, generic).
//!
//! Moved from `Kimix-chat-state::compaction_utils::build_compacted_history` and
...
//! ```
//!
//! Kimix is the canonical harness. The summary carrier text is built by
...
pub fn assemble_compacted_history<T: CompactionItemFactory>(
    ...
    // Kimix keeps the legacy `<user_query>`-wrapped continuation text and
...
mod tests {
    ...
    #[test]
    fn kimix_order_recent_before_summary() {
