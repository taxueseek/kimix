//! Observability seam for the full-replace (Kimix) pass.
//!
//! The shared orchestrator reports per-attempt and terminal outcomes through
//! this trait so each harness can emit its own telemetry (Kimix:
...
//!
//! Emission points are part of the behavior contract: the Kimix observer
