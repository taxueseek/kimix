...
//! string/text manipulation. Harness-bound extraction (Kimix chat's
//! `KimixConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `KimixMessage` assembly) stays in the harness crate.
pub mod filter;
pub mod prompt;
pub mod types;
pub mod validate;
