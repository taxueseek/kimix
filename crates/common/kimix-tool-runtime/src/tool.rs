...
/// `filename`, `path`, `metadata`) that the Kimix SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Kimix SLOP converter to
    ...
    /// - `path`: file path on the Kimix Computer filesystem
