#[cfg(test)]
mod tests {
    use crate::{KimixRecallEngine, KimixPromptAdapter};

    #[test] fn recall_engine_new_empty() {
        assert_eq!(KimixRecallEngine::new().turn_count(), 0);
    }
    #[test] fn recall_engine_add_turn() {
    ...
    #[test] fn recall_engine_relevant() {
        let mut e = KimixRecallEngine::new();
    ...
    #[test] fn recall_engine_zero_chars() {
        let mut e = KimixRecallEngine::new();
